...
<div class="home-banner">
      <div class="home-banner-left">
        <div class="home-bann-content">
          ...
          <?php $head = get_field("banner_sub_heading");?>
          <p><?php echo esc_html($head) ?></p>

          <?php $sch= get_field("sch");?>
          <a class="sch-tour" href="<?php echo esc_html($sch) ?>">Schedule A Tour</a>
        </div>
      </div>
    ...
    <?php $cen= get_field("santury");?>
     ...
     <div class="cen">
      ...
      <?php $cen_para= get_field("santury_paragraph");?>
        ...
        <a class="sch-tour" href="<?php echo esc_html($cen_btn) ?>">SEE WHAT'S HERE</a>
      </div>
    </div>
</div>
    ...
    <div class="image-two">
      ...
      <?php $pic02= get_field("pic02");?>
        ...
        <div class="right-image-content">
          ...
          <a class="sch-tour" href="<?php echo esc_html($learn_more) ?>">Learn More</a>
        </div>
      </div>
    </div>
    ...
    <div class="newly-refresh">
      ...
      <div class="newly-content">
        <div class="newly-left">
         ...
         <?php $view= get_field("view_floor_plans");?>
         <a class="sch-tour" href="href="<?php echo esc_html($view) ?>">View Floor Plans</a>
        </div>
